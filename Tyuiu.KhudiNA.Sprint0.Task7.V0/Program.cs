...
using Tyuiu.KhudiNA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.KhudiNA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнила: Худи Н. А. | ИСТНб-24-1";
            ...
            Console.WriteLine("* Выполинла: Худи Наталья Александровна | ИСТНб-24-1                      *");
            Console.WriteLine("***************************************************************************");
